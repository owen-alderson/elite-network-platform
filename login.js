...
(function () {
  ...
  async function signInWithPassword(email, password) {
    ...
    var res = await window.aether.client.auth.signInWithPassword({
      email: email,
      password: password
    });
  ...
  async function sendPasswordReset(email) {
    ...
    var res = await window.aether.client.auth.resetPasswordForEmail(email, {
    ...
    setStatus('If you have an Aether account, a password-reset link is on its way to your inbox.', 'success');
  }
